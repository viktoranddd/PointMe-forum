...
class Comments(models.Model):
    ...
    comm_datetime = models.DateTimeField(blank=True, null=True)
    is_visible = models.IntegerField(blank=True, null=True)
    is_normal = models.IntegerField(blank=True, null=True)
...
class Posts(models.Model):
    ...
    post_status = models.IntegerField(blank=True, null=True)
